import math
names={'0': ['abstain', 'no vote', 'unvote', 'no lynch'], '109': ['Karp'], '14': ['Reaper', 'Reapa&#039;', 'Reapa\''], '3': ['RandomizeR'], '9': ['Ben', 'LaserWolf', 'ChatBot'], '12': ['Dietcar', 'Dieter', 'Dietrich'], '1': ['Mystic', 'michael'], '52': ['guy', 'guywithhat', 'snoop.gov', 'Guy', 'lemonnuts', 'angellord01', 'gmite', 'mystic the batman', 'batman', 'coolalien56', 'penut', 'GuyWithShark', 'GestorbenWithShark', 'matt miller', 'birfday guy'], '10': ['Kenigmatic', 'Enig.matic', 'KC'], '8': ['Aponda'], '19': ['Waffles'], '20': ['Phil', 'HandBanana', 'Everyone'], '13': ['AzraelJaffar', 'Azrael', 'Az Real', 'AJ', 'AzraelPariah'], '22': ['LiquidAngel', 'ReplicaMan35'], '17': ['Lymric'], '23': ['That_Kid'], '25': ['Haplo'], '26': ['Kobu'], '21': ['Red'], '5': ['Cole', 'Dr. Death', 'PboFlow', 'TRIwofl'], '39': ['Dr. Agon', 'gregor'], '41': ['Diage'], '49': ['Iron', 'Ion'], '43': ['Daron'], '18': ['SwoopDoggyDog', 'staticworth', 'swoop'], '46': ['DMGunner'], '56': ['capt_dan'], '65': ['schlingy'], '57': ['euphoria'], '37': ['Conrad', 'KillaCondor', 'conner'], '70': ['TriviaBot'], '86': ['Ribos'], '85': ['eep', 'epplant', 'eggeepjeepwhatislegplant'], '94': ['Trientalis', 'Trent'], '114': ['Death Butt', 'paraffin', 'death butt', 'dead butt', 'death nutt', 'Methphukbuttdeth', 'desu', 'db', 'buttbutt'], '117': ['Cameroni&Cheese', 'Cameroni&amp;Cheese', 'AngryNarwhal', 'Angynawhaaa', 'nawa', 'narwhal', 'Orangeangrygangbanger'], '118': ['Modi Thorson', 'Modi Thursday', 'Mightyhightymodilowti', 'Moði Thorson'], '122': ['anime'], '124': ['Valex'], '120': ['ktern', 'k//', 'kternal'], '189': ['bigbird'], '199': ['vorporeal'], '203': ['liftedpixel'], '208': ['Rocuronium', 'adderallforall', 'Levetiracetam', 'pills', 'rocu'], '206': ['yeagz'], '201': ['xazarus', 'xaz'], '32': ['zoomlaski6', 'zoom'], '215': ['xazBot'], '216': ['Lord Monochromicorn']}
name_lookup = {}
name_list = []
failed = []
...
def name_find(nick):
    ...
    metric = best_substring_l_distance(best_guess.lower(), nick)
    if metric > 1.75: #based on my tests, this is a decent benchmark
        return(best_guess)
    elif metric >= 1.4:
